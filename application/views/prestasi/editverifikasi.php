        ...
        <div class="col-lg">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="bidang_prestasi" name="bidang_prestasi" value="<?= $prestasi['bidang_prestasi']; ?>" readonly>
                    <?= form_error('bidang_prestasi', '<small class="text-danger">', '</small>'); ?>
                </div>

                <div class="form-group">
                    <label for="nama_kegiatan">Nama Kegiatan</label>
                    <input type="text" class="form-control" id="nama_kegiatan" name="nama_kegiatan" value="<?= $prestasi['nama_kegiatan']; ?>" disabled>
                </div>

                <div class="form-group">
                    <label for="tanggal_kegiatan">Tanggal Kegiatan</label>
                    <input type="date" class="form-control" id="tanggal_kegiatan" name="tanggal_kegiatan" value="<?= $prestasi['tanggal_kegiatan']; ?>" disabled>
                </div>

                <div class="form-group">
                    <label for="komponen_prestasi">Komponen Prestasi</label>
                    <select class="form-control" id="komponen_prestasi" name="komponen_prestasi" required disabled>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="penyelenggara" name="penyelenggara" value="<?= $prestasi['penyelenggara']; ?>" disabled>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="status" name="status" required>
                        ...
                        <option value="diajukan" <?= ($prestasi['status'] == 'diajukan') ? 'selected' : ''; ?>>Diajukan</option>
                        <option value="diterima" <?= ($prestasi['status'] == 'diterima') ? 'selected' : ''; ?>>Diterima</option>
                        <option value="ditolak" <?= ($prestasi['status'] == 'ditolak') ? 'selected' : ''; ?>>Ditolak</option>
                    </select>
                </div>

                <div class="form-group">
                    <label for="catatan">Catatan</label>
                    <input type="text" class="form-control" id="catatan" name="catatan" value="<?= $prestasi['catatan']; ?>">
                </div>

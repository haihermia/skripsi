...
<div class="container-fluid">
    ...
    <div class="card shadow">
        <div class="card-body">
            <form action="<?= base_url('pengajuanverifikasi/updatefrommahasiswa/' . $pengajuan['id']); ?>" method="POST" enctype="multipart/form-data">
                ...
                <a href="<?= base_url('pengajuanverifikasi/pengajuanku'); ?>" class="btn btn-secondary">Batal</a>
            </form>
        </div>
    </div>
